...
public class Clickgui extends Mod {
    ...
    public static BooleanSetting flatMode =
        new BooleanSetting("Flat mode", false);
    public static BooleanSetting reloadTheme =
        new BooleanSetting("Save Theme", false);
    ...
    public Clickgui() {
        ...
        addSettings(
            ...
            colorTitle, colorSelected, flatMode, reloadTheme
        );
