...
public class ChatUtils {
    ...
    static ClientPlayNetworkHandler nh =
    ...
    public static void warn(String message) { message(warnprefix + message); }

    public static void error(String message) { message(errprefix + message); }
    ...
    public static void sendMsg(String message) {
        ...
        if (message.startsWith("/"))
            nh.sendChatCommand(message.substring(1));
        else
